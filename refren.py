    ...
    try:
        ...
        response = client.messages.parse(
            ...
            system=(
                ...
                "IMPORTANT SPECIAL CASE: If the paper is an arXiv preprint — identified by an arXiv ID "
                "(e.g. 'arXiv:2506.19540'), the arXiv logo, or text like 'Submitted to arXiv' — "
                "set journal_full_name to 'arXiv' and journal_abbreviation to 'arXiv'. "
                "Do NOT use the name of a conference, workshop, or subject area as the journal name for arXiv preprints. "
